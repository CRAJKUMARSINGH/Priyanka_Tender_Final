...
def set_custom_theme():
    st.set_page_config(
        page_title="Priyanka Tender Final",
        page_icon="🏗️",  # Default icon, can be replaced with logo.png if available
        layout="centered",
        initial_sidebar_state="auto"
    )

    # Custom CSS for balloon theme
    custom_css = """
    <style>
        .stApp {
        ...
        .stTextInput>div>div>input {
            background-color: #f0f0f0; /* Light grey for text inputs */
        }
