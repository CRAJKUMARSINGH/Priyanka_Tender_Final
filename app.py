...
def handle_bidder_management():
    ...
    bidder_database = {
        ...
        "InfraTech Solutions": {
            ...
            "registration_number": "U74999MH2012PTC234567",
            "pan_number": "AAECD3456D",
            "gstin": "27AAECD3456D1Z8",
            "average_rating": 4.3,
            "projects_completed": 38,
            "specialization": ["Smart City Projects", "Infrastructure Development"]
        },
        "Green Earth Constructions": {
            "address": "202 Eco Tower, Green City",
            "last_used": "2024-08-10",
            "contact_person": "Ms. Neha Gupta",
            "email": "neha.gupta@greenearthconst.com",
            "phone": "+91 98765 87654",
            "registration_number": "U45201MH2015PTC256789",
            "pan_number": "AAECE7890E",
            "gstin": "27AAECE7890E1Z9",
            "average_rating": 4.6,
            "projects_completed": 53,
            "specialization": ["Green Buildings", "Sustainable Construction"]
        }
    }
    ...
    if num_bidders:
            ...
            with st.expander(f"🏢 Bidder {i+1} Details", expanded=True):
                ...
                with col1:
                    ...
                    if selected_bidder and selected_bidder in bidder_database:
                        st.info(f"📍 **Address:** {bidder_database[selected_bidder].get('address', 'N/A')}")
                        st.success(f"🗓️ **Last Used:** {bidder_database[selected_bidder].get('last_used', 'Never')}")
        ...
        with col3:
            if st.button("🎨 Show UI Features", type="secondary"):
        ...
        if st.session_state.get('bidders'):
            ...
            for i, bidder in enumerate(st.session_state.bidders):
                df_data.append({
                    ...
                    'Bid Amount': f"₹{bidder.get('bid_amount', 0):,.2f}",
                    'Status': '✅ Active'
                })
